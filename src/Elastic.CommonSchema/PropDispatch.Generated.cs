	...
	internal static partial class PropDispatch
	{
		...
		internal static bool TrySet(EcsDocument document, string path, object value) 
		{
			switch (path) 
			{
				...
				case "dll.name":
				case "DllName":
				case "dll.origin_referrer_url":
				case "DllOriginReferrerUrl":
				case "dll.origin_url":
				case "DllOriginUrl":
				case "dll.path":
				case "DllPath":
				...
				case "file.name":
				case "FileName":
				case "file.origin_referrer_url":
				case "FileOriginReferrerUrl":
				case "file.origin_url":
				case "FileOriginUrl":
				case "file.owner":
				case "FileOwner":
				case "file.path":
				...
				case "threat.indicator.file.origin_referrer_url":
				case "ThreatIndicatorFileOriginReferrerUrl":
				case "threat.indicator.file.origin_url":
				case "ThreatIndicatorFileOriginUrl":
		...
		public static Func<Dll, object, bool> TryAssignDll(string path)
		{
			Func<Dll, object, bool> assign = path switch
			{
				...
				"dll.origin_referrer_url" => static (e, v) => TrySetString(e, v, static (ee, p) => ee.OriginReferrerUrl = p),
				"DllOriginReferrerUrl" => static (e, v) => TrySetString(e, v, static (ee, p) => ee.OriginReferrerUrl = p),
				"dll.origin_url" => static (e, v) => TrySetString(e, v, static (ee, p) => ee.OriginUrl = p),
				"DllOriginUrl" => static (e, v) => TrySetString(e, v, static (ee, p) => ee.OriginUrl = p),
		...
		public static Func<File, object, bool> TryAssignFile(string path)
		{
			Func<File, object, bool> assign = path switch
			{
				...
				"FileOriginReferrerUrl" => static (e, v) => TrySetString(e, v, static (ee, p) => ee.OriginReferrerUrl = p),
				"file.origin_url" => static (e, v) => TrySetString(e, v, static (ee, p) => ee.OriginUrl = p),
		...
		public static Func<Threat, object, bool> TryAssignThreat(string path)
		{
			Func<Threat, object, bool> assign = path switch
			{
				...
				"threat.indicator.file.origin_referrer_url" => static (e, v) => TryAssignFile("file.origin_referrer_url")(e.IndicatorFile ??= new File(),v),
				"ThreatIndicatorFileOriginReferrerUrl" => static (e, v) => TryAssignFile("file.origin_referrer_url")(e.IndicatorFile ??= new File(),v),
				"threat.indicator.file.origin_url" => static (e, v) => TryAssignFile("file.origin_url")(e.IndicatorFile ??= new File(),v),
				"ThreatIndicatorFileOriginUrl" => static (e, v) => TryAssignFile("file.origin_url")(e.IndicatorFile ??= new File(),v),
