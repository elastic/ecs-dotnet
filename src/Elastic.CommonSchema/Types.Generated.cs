...
namespace Elastic.CommonSchema
{
	...
	public class CodeSignature 
	{
		...
		/// <summary>
		/// Boolean to capture if the digital signature is verified against the binary content.<para/>Leave unpopulated if a certificate was unchecked.
		/// </summary>
		/// <remarks>Extended</remarks>
		/// <example>true</example>
		...
		/// <summary>
		/// Stores the trust status of the certificate chain.<para/>Validating the trust of the certificate chain may be complicated, and this field should only be populated by tools that actively check the status.
		/// </summary>
		/// <remarks>Extended</remarks>
		/// <example>true</example>
		...
		/// <summary>
		/// Additional information about the certificate status.<para/>This is useful for logging cryptographic errors with the certificate validity or trust status. Leave unpopulated if the validity or trust of the certificate was unchecked.
		/// </summary>
		/// <remarks>Extended</remarks>
	...
	public class Dll 
	{
		...
		/// <summary>
		/// Name of the library.<para/>This generally maps to the name of the file on disk.
		/// </summary>
		/// <remarks>Core</remarks>
	...
	public class EventKind
	{
        ...
        /// <summary>
        /// This value is used to indicate that this event describes a numeric measurement taken at given point in time.<para/>Examples include CPU utilization, memory usage, or device temperature.<para/>Metric events are often collected on a predictable frequency, such as once every few seconds, or once a minute, but can also be used to describe ad-hoc numeric metric queries.
		/// </summary>
		public const string Metric = "metric";

        /// <summary>
        /// The state value is similar to metric, indicating that this event describes a measurement taken at given point in time, except that the measurement does not result in a numeric value, but rather one of a fixed set of categorical values that represent conditions or states.<para/>Examples include periodic events reporting Elasticsearch cluster state (green/yellow/red), the state of a TCP connection (open, closed, fin_wait, etc.), the state of a host with respect to a software vulnerability (vulnerable, not vulnerable), and the state of a system regarding compliance with a regulatory standard (compliant, not compliant).<para/>Note that an event that describes a change of state would not use `event.kind:state`, but instead would use 'event.kind:event' since a state change fits the more general event definition of something that happened.<para/>State events are often collected on a predictable frequency, such as once every few seconds, once a minute, once an hour, or once a day, but can also be used to describe ad-hoc state queries.
		/// </summary>
	...
	/// <summary>
	/// This is one of four ECS Categorization Fields, and indicates the lowest level in the ECS category hierarchy.<para/>`event.outcome` simply denotes whether the event represents a success or a failure from the perspective of the entity that produced the event.<para/>Note that when a single transaction is described in multiple events, each event may populate different values of `event.outcome`, according to their perspective.<para/>Also note that in the case of a compound event (a single event that contains multiple logical events), this field should be populated with the value that best captures the overall success or failure from the perspective of the event producer.<para/>Further note that not all events will have an associated outcome. For example, this field is generally not populated for metric events, events with `event.type:info`, or any events for which an outcome does not make logical sense.
    /// </summary>
	...
	public class Event 
	{
		...
		/// <summary>
		/// Sequence number of the event.<para/>The sequence number is a value published by some event sources, to make the exact ordering of events unambiguous, regardless of the timestamp precision.
		/// </summary>
		/// <remarks>Extended</remarks>
		...
		/// <summary>
		/// Reference URL linking to additional information about this event.<para/>This URL links to a static definition of the this event. Alert events, indicated by `event.kind:alert`, are a common use case for this field.
		/// </summary>
		/// <remarks>Extended</remarks>
		...
		/// <summary>
		/// URL linking to an external system to continue investigation of this event.<para/>This URL links to another system where in-depth investigation of the specific occurence of this event can take place. Alert events, indicated by `event.kind:alert`, are a common use case for this field.
		/// </summary>
		/// <remarks>Extended</remarks>
	...
	public class File 
	{
		...
		/// <summary>
		/// Drive letter where the file is located. This field is only relevant on Windows.<para/>The value should be uppercase, and not include the colon.
		/// </summary>
		/// <remarks>Extended</remarks>
		/// <example>C</example>
	...
	public class ParentCodeSignature
	{
		...
		/// <summary>
		/// Parent Boolean to capture if the digital signature is verified against the binary content.<para/>Leave unpopulated if a certificate was unchecked.
		/// </summary>
		/// <remarks>Extended</remarks>
		/// <example>true</example>
		[DataMember(Name = "")]
		...
		/// <summary>
		/// Parent Stores the trust status of the certificate chain.<para/>Validating the trust of the certificate chain may be complicated, and this field should only be populated by tools that actively check the status.
		/// </summary>
		/// <remarks>Extended</remarks>
		/// <example>true</example>
		[DataMember(Name = "")]
		...
		/// <summary>
		/// Parent Additional information about the certificate status.<para/>This is useful for logging cryptographic errors with the certificate validity or trust status. Leave unpopulated if the validity or trust of the certificate was unchecked.
		/// </summary>
		/// <remarks>Extended</remarks>
		/// <example>ERROR_UNTRUSTED_ROOT</example>
		[DataMember(Name = "")]
	...
	public class ProcessParent
	{
		...
		/// <summary>
		/// Unique identifier for the process.<para/>The implementation of this is specified by the data source, but some examples of what could be used here are a process-generated UUID, Sysmon Process GUIDs, or a hash of some uniquely identifying components of a process.<para/>Constructing a globally unique identifier is a common practice to mitigate PID reuse as well as to identify a specific process over time, across multiple monitored hosts.
		/// </summary>
		/// <remarks>Extended</remarks>
	...
	public class Rule 
	{
		...
		/// <summary>
		/// Reference URL to additional information about the rule used to generate this event.<para/>The URL can point to the vendor's documentation about the rule. If that's not available, it can also be a link to a more general page describing this type of alert.
		/// </summary>
		/// <remarks>Extended</remarks>
