...
{
	/// <summary>
	/// Elastic Common Schema version 1.4.0
	/// <para/>
...
{
	/// <summary>
	/// Elastic Common Schema version 1.4.0 index templates to be used with Elasticsearch.
	/// </summary>
	public static class IndexTemplates
	{
		/// <summary>
		/// Elastic Common Schema version 1.4.0 index template for Elasticsearch version 6
